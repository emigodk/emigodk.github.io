...
$consulta = "INSERT INTO usuarios (email, nombre, usuario, passwd) VALUES ('$email', '$nombre', '$usuario', '$passwd')";
...
.error__close path {
  fill: #fff;
    ...
    echo '</div>';
    echo '<div class="error__title">Error al crear cuenta, introduce correctamente los campos</div>';
